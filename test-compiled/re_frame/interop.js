...
return [cljs.core.str((function (){var pred__13680 = cljs.core.instance_QMARK_;
var expr__13681 = reactive_val;
if(cljs.core.truth_(pred__13680.call(null,reagent.ratom.RAtom,expr__13681))){
return "ra";
} else {
if(cljs.core.truth_(pred__13680.call(null,reagent.ratom.RCursor,expr__13681))){
return "rc";
} else {
if(cljs.core.truth_(pred__13680.call(null,reagent.ratom.Reaction,expr__13681))){
return "rx";
} else {
if(cljs.core.truth_(pred__13680.call(null,reagent.ratom.Track,expr__13681))){
return "tr";
} else {
return "other";
}
