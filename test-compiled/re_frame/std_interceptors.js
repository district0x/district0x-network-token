...
var vec__24629_24632 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24633 = cljs.core.nth.call(null,vec__24629_24632,(0),null);
var only_after_24634 = cljs.core.nth.call(null,vec__24629_24632,(1),null);
var db_changed_QMARK__24635 = (cljs.core.some_QMARK_.call(null,only_before_24633)) || (cljs.core.some_QMARK_.call(null,only_after_24634));
if(db_changed_QMARK__24635){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_24633);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_24634);
...
var map__24642 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__24642__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24642__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24650 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.call(null,map__24650__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__12775__auto___24653 = arguments.length;
var i__12776__auto___24654 = (0);
while(true){
if((i__12776__auto___24654 < len__12775__auto___24653)){
args__12782__auto__.push((arguments[i__12776__auto___24654]));

var G__24655 = (i__12776__auto___24654 + (1));
i__12776__auto___24654 = G__24655;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__12783__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24652){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24652));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__11700__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__12782__auto__ = [];
var len__12775__auto___24661 = arguments.length;
var i__12776__auto___24662 = (0);
while(true){
if((i__12776__auto___24662 < len__12775__auto___24661)){
args__12782__auto__.push((arguments[i__12776__auto___24662]));

var G__24663 = (i__12776__auto___24662 + (1));
i__12776__auto___24662 = G__24663;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__12783__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__24656_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24657_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24657_SHARP_);
...
var G__24659 = cljs.core.first.call(null,seq24658);
var seq24658__$1 = cljs.core.next.call(null,seq24658);
var G__24660 = cljs.core.first.call(null,seq24658__$1);
var seq24658__$2 = cljs.core.next.call(null,seq24658__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__24659,G__24660,seq24658__$2);
});
