...
var len__12775__auto___36290 = arguments.length;
var i__12776__auto___36291 = (0);
while(true){
if((i__12776__auto___36291 < len__12775__auto___36290)){
args__12782__auto__.push((arguments[i__12776__auto___36291]));

var G__36292 = (i__12776__auto___36291 + (1));
i__12776__auto___36291 = G__36292;
continue;
} else {
}
break;
...
return cljs.test.run_block.call(null,(function (){var env36288 = cljs.test.empty_env.call(null);
var summary36289 = cljs.core.volatile_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"summary","summary",380847952),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"test","test",577538877),(0)], null));
return cljs.core.concat.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env36288,summary36289){
return (function (){
cljs.test.set_env_BANG_.call(null,env36288);
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env__13729__auto__,env36288,summary36289){
return (function (){
...
});})(env36288,summary36289))
,((function (env36288,summary36289){
return (function (){
return cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Symbol(null,"contribution.tests","contribution.tests",-774683836,null),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-ns","end-test-ns",1620675645)], null));
});})(env36288,summary36289))
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env36288,summary36289){
return (function (){
return cljs.core._vreset_BANG_.call(null,summary36289,cljs.core.partial.call(null,cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref.call(null,summary36289),new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242).cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_.call(null))));
});})(env36288,summary36289))
], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (env36288,summary36289){
return (function (){
cljs.test.set_env_BANG_.call(null,env36288);

cljs.test.do_report.call(null,cljs.core.deref.call(null,summary36289));

cljs.test.report.call(null,cljs.core.assoc.call(null,cljs.core.deref.call(null,summary36289),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)));
...
contribution.cmd._main.cljs$lang$applyTo = (function (seq36287){
return contribution.cmd._main.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36287));
});
