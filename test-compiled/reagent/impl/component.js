...
if((i < len)){
var k = (ks[i]);
var G__13416 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__13417 = (i + (1));
m = G__13416;
i = G__13417;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__13421 = c;
var G__13421__$1 = (((G__13421 == null))?null:G__13421.prototype);
if((G__13421__$1 == null)){
return null;
} else {
return (G__13421__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__13425 = c;
var G__13425__$1 = (((G__13425 == null))?null:G__13425.prototype);
if((G__13425__$1 == null)){
return null;
} else {
return (G__13425__$1["render"]);
}
})()));
});
...
var _STAR_current_component_STAR_13434 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13434;
}});
...
var G__13438 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13438) {
...
var or__11700__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__13440_13442 = (c["cljsRatom"]);
if((G__13440_13442 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__13440_13442);
}
...
if(cljs.core.truth_((function (){var and__11688__auto__ = wrap;
...
var render_fun_13446 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_13445));
if((cljs.core.count.call(null,renders_13445) > (0))){
} else {
...
if(((1) === cljs.core.count.call(null,renders_13445))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_13446)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_13446))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__11700__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
} else {
...
var render_fun__$1 = (function (){var or__11700__auto__ = render_fun;
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__11700__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
} else {
...
var name__$1 = (function (){var G__13444 = name;
switch (G__13444) {
case "":
...
var G__13449 = o;
(G__13449[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__13455 = (function (){var or__11700__auto__ = (function (){var G__13457 = c;
if((G__13457 == null)){
return null;
} else {
return (G__13457["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
...
return (G__13455["_currentElement"]);
}
})();
var name = (function (){var G__13458 = elem;
var G__13458__$1 = (((G__13458 == null))?null:(G__13458["type"]));
if((G__13458__$1 == null)){
return null;
} else {
return (G__13458__$1["displayName"]);
}
})();
var path = (function (){var G__13459 = elem;
var G__13459__$1 = (((G__13459 == null))?null:(G__13459["_owner"]));
var G__13459__$2 = (((G__13459__$1 == null))?null:reagent$impl$component$component_path.call(null,G__13459__$1));
if((G__13459__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13459__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__11700__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
} else {
var G__13461 = c;
var G__13461__$1 = (((G__13461 == null))?null:G__13461.constructor);
if((G__13461__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__13461__$1);
}
}
})();
