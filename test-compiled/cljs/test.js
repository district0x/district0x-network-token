...
var args19356 = [];
var len__12775__auto___19360 = arguments.length;
var i__12776__auto___19361 = (0);
while(true){
if((i__12776__auto___19361 < len__12775__auto___19360)){
args19356.push((arguments[i__12776__auto___19361]));

var G__19362 = (i__12776__auto___19361 + (1));
i__12776__auto___19361 = G__19362;
continue;
} else {
}
break;
...
var G__19359 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__19359,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__19359;
}
});
...
var or__11700__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__12775__auto___19367 = arguments.length;
var i__12776__auto___19368 = (0);
while(true){
if((i__12776__auto___19368 < len__12775__auto___19367)){
args__12782__auto__.push((arguments[i__12776__auto___19368]));

var G__19369 = (i__12776__auto___19368 + (1));
i__12776__auto___19368 = G__19369;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__12783__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq19364){
var G__19365 = cljs.core.first.call(null,seq19364);
var seq19364__$1 = cljs.core.next.call(null,seq19364);
var G__19366 = cljs.core.first.call(null,seq19364__$1);
var seq19364__$2 = cljs.core.next.call(null,seq19364__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__19365,G__19366,seq19364__$2);
});
...
var file = cljs.core.get.call(null,map__19373__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19373__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19373__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__19373,map__19373__$1,file,line,column){
return (function (p1__19370_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__19370_SHARP_));
});})(map__19373,map__19373__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__12625__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__12625__auto__,prefer_table__12626__auto__,method_cache__12627__auto__,cached_hierarchy__12628__auto__,hierarchy__12629__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__11700__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__11700__auto__)){
return or__11700__auto__;
} else {
...
var temp__4657__auto___19375 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___19375)){
var message_19376 = temp__4657__auto___19375;
cljs.core.println.call(null,message_19376);
} else {
}
...
var temp__4657__auto___19377 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___19377)){
var message_19378 = temp__4657__auto___19377;
cljs.core.println.call(null,message_19378);
} else {
}
...
var temp__4655__auto__ = (function (){var and__11688__auto__ = typeof exception.stack === 'string';
if(and__11688__auto__){
var G__19388 = exception.stack;
var G__19388__$1 = (((G__19388 == null))?null:clojure.string.split_lines.call(null,G__19388));
var G__19388__$2 = (((G__19388__$1 == null))?null:cljs.core.get.call(null,G__19388__$1,depth));
if((G__19388__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__19388__$2);
}
} else {
...
var vec__19389 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__19389,(0),null);
var column = cljs.core.nth.call(null,vec__19389,(1),null);
var vec__19392 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__19392,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__19392,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__19392,(2),null);
...
var m__$1 = (function (){var G__19396 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__19396) {
case "fail":
...
var G__19402 = (function (){var G__19401 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__19401);
} else {
return G__19401;
}
})();
...
return cljs.core.vary_meta.call(null,G__19404,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e19407){var e = e19407;
var G__19408 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__19408) {
...
var vec__19413 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__19413,(0),null);
var types = vec__19413;
...
return cljs.core.map.call(null,(function (p__19425){
var vec__19426 = p__19425;
var ns = cljs.core.nth.call(null,vec__19426,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__19426,(1),null);
return ((function (vec__19426,ns,vars__$1){
return (function (){
...
var G__19429 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__19429) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1){
return (function (){
var seq__19430 = cljs.core.seq.call(null,vars__$1);
var chunk__19431 = null;
var count__19432 = (0);
var i__19433 = (0);
while(true){
if((i__19433 < count__19432)){
var v = cljs.core._nth.call(null,chunk__19431,i__19433);
var temp__4657__auto___19435 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___19435)){
var t_19436 = temp__4657__auto___19435;
each_fixture_fn.call(null,((function (seq__19430,chunk__19431,count__19432,i__19433,t_19436,temp__4657__auto___19435,v,each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19436)));
});})(seq__19430,chunk__19431,count__19432,i__19433,t_19436,temp__4657__auto___19435,v,each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1))
);
} else {
}

var G__19437 = seq__19430;
var G__19438 = chunk__19431;
var G__19439 = count__19432;
var G__19440 = (i__19433 + (1));
seq__19430 = G__19437;
chunk__19431 = G__19438;
count__19432 = G__19439;
i__19433 = G__19440;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__19430);
if(temp__4657__auto__){
var seq__19430__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__19430__$1)){
var c__12511__auto__ = cljs.core.chunk_first.call(null,seq__19430__$1);
var G__19441 = cljs.core.chunk_rest.call(null,seq__19430__$1);
var G__19442 = c__12511__auto__;
var G__19443 = cljs.core.count.call(null,c__12511__auto__);
var G__19444 = (0);
seq__19430 = G__19441;
chunk__19431 = G__19442;
count__19432 = G__19443;
i__19433 = G__19444;
continue;
} else {
var v = cljs.core.first.call(null,seq__19430__$1);
var temp__4657__auto___19445__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___19445__$1)){
var t_19446 = temp__4657__auto___19445__$1;
each_fixture_fn.call(null,((function (seq__19430,chunk__19431,count__19432,i__19433,t_19446,temp__4657__auto___19445__$1,v,seq__19430__$1,temp__4657__auto__,each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_19446)));
});})(seq__19430,chunk__19431,count__19432,i__19433,t_19446,temp__4657__auto___19445__$1,v,seq__19430__$1,temp__4657__auto__,each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1))
);
} else {
}

var G__19447 = cljs.core.next.call(null,seq__19430__$1);
var G__19448 = null;
var G__19449 = (0);
var G__19450 = (0);
seq__19430 = G__19447;
chunk__19431 = G__19448;
count__19432 = G__19449;
i__19433 = G__19450;
continue;
}
} else {
...
});})(each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1))
);
});})(each_fixture_fn,G__19429,env,once_fixtures,each_fixtures,vec__19426,ns,vars__$1))
], null);
